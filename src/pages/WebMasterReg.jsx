...
import { webmasterSchema } from '../validators/formValidation'
...
const Register = () => {
   const {
    ...
    handleSubmit,    
    formState: { errors }
  } = useForm({ resolver: zodResolver(webmasterSchema),
...
if (registered) return(
  ...
  return (
    <form onSubmit={handleSubmit(registerWebmaster)}>
          ...
          <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20 w-full">
            <div className="max-w-md mx-auto">
              <div>
                ...
                <h1 className="text-3xl font-semibold text-center py-2">Webmaster</h1>
              </div>
